...
**SIGUIENTE PASO → PASO 14** — Conocimiento inicial: `610_knowledge/decisions_library.md` (resumen de DEC-012/014/024/044/047/057 que B consulta en Modo PLAN) + `lessons_learned.md` (encabezado vacío). Son archivos **runtime**; el `intake-governor` E10-A.8 ya los bootstrapea si faltan, pero el contenido curado es el PASO 14. Después: PASO 15 (early-eval E9, gate ≥ 0.7) y PASO 16 (corrida e2e en terminal de prueba).
